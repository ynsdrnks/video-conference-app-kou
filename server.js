...
io.on('connect', socket => {
    ...
    socket.on("join room", (roomid, username) => { //buraya mikrofon ve video için açık kapalı bilgisi de gönderilebilir
    ...
    socket.on('createmetin', (sendmetin, flag_file, dosyaadi, event, filesize, recSize) => {
        socket.to(socketroom[socket.id]).emit('createmetin', sendmetin, flag_file, dosyaadi, event, filesize, recSize);
    });
